   ...
   return (
      <React.Fragment>
         ...
         <div className="container mx-auto text-center text-blue-200 ">
            ...
            <div className="container flex flex-col gap-4 font-bold text-[#694201] md:flex-row  md:mx-auto md:justify-around">
               <a target='_blank' className="flex gap-2 justify-center target-blank hover:underline underline-offset-4"
               href="https://www.linkedin.com/in/diego-solit-527259217/">
               <img src="/linkd.png" alt="incone linkdlin" />
               DiegoSolit
               </a>
               <a target='_blank' className="flex gap-2 justify-center target-blank hover:underline underline-offset-8"
